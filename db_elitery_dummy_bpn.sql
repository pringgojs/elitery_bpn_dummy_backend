...
-- Dumping data for table db_elitery_dummy_bpn.dummies: ~3 rows (approximately)
...
INSERT INTO `dummies` (`NIB`, `KOTAK`, `LUAS`, `HAK`, `DESA_KELURAHAN`, `KECAMATAN`, `KABUPATEN_KOTAMADYA`, `PROVINSI`) VALUES
	...
	('28060102.03863', 'B3', '199 m2 (Seratus Sembilan Puluh Sembilan Meter Persegi)	', 'MILIK', 'KOTASARI INDAH', 'GEROGOL', 'CILEGON', 'Jawa Barat'),
